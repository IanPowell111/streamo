            ...
            <div class="product-details-content container">
                <ul class="my-5">
                    <li v-for="(item, index) in product.items" :key="index" class="text-[16px] mb-3 text-[#dddddd] font-light">
                        <span class="text-[18px] font-semibold mr-1 text-green-brand">{{item.label}} </span>{{item.labeldesc}}
                    </li>
                </ul>
                ...
                <div class="flex items-center justify-between flex-wrap mt-9 py-3 border-y-1 border-[#dddddd]">
                    <div class="flex items-center">
                        <span class="text-[18px] font-semibold text-green-brand">Share:</span>
                        <div class="social-style-1 flex items-center">
                            <a class="sm:h-[35px] sm:w-[35px] h-[30px] w-[30px] text-[14px] flex items-center justify-center bg-white text-[#18163a] hover:bg-green-brand hover:text-white rounded-full sm:ml-3 ml-2" href="https://www.facebook.com/"> 
                                <i class="zmdi zmdi-facebook"></i>
                            </a>
                            <a class="sm:h-[35px] sm:w-[35px] h-[30px] w-[30px] text-[14px] flex items-center justify-center bg-white text-[#18163a] hover:bg-green-brand hover:text-white rounded-full sm:ml-3 ml-2" href="https://twitter.com/"> 
                                <i class="zmdi zmdi-twitter"></i>
                            </a>
                            <a class="sm:h-[35px] sm:w-[35px] h-[30px] w-[30px] text-[14px] flex items-center justify-center bg-white text-[#18163a] hover:bg-green-brand hover:text-white rounded-full sm:ml-3 ml-2" href="https://www.linkedin.com/"> 
                                <i class="zmdi zmdi-linkedin"></i>
                            </a>
                        </div>
                    </div>
                    <div class="like-dislike-wrap">
                        <button class="like-dislike-style text-[20px] sm:text-[30px] text-white hover:text-green-brand mr-2"><i class="zmdi zmdi-thumb-up"></i></button>
                        <button class="like-dislike-style text-[20px] sm:text-[30px] text-white hover:text-green-brand ml-2"><i class="zmdi zmdi-thumb-down"></i></button>
                    </div>
                </div>
            </div>
        </div>
