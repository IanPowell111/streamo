<template>
    ...
    <div class="hero-slider group relative">
                ...
                >
                    <div class="slider-content ml-4 pr-4 xl:ml-10 2xl:ml-[100px] z-9 relative">
                        ...
                        <div class="flex items-center animation-two">
                            <span class="subtitle text-green-brand text-[25px] lg:text-[35px] font-bold">{{product.newprice}}</span>
                        ...
                        <div class="flex items-center mt-7 sm:mt-10 md:mt-14 animation-three">
                            ...
                            <n-link class="inline-block rounded-[3px] transition-all duration-300 sm:py-[15px] sm:px-[25px] px-[20px] py-[10px] bg-green-brand text-white font-semibold hover:bg-white hover:text-[#333333] !text-[16px]" :to="`/${(PageLink)}/${slugify(product.title)}`" >Watch Now</n-link>
        ...
        <div class="hero-slider_arrows flex justify-between w-full absolute top-1/2 -translate-y-1/2 z-99">
            <div class="hero-slider_arrows__prevbtn swipper-arrow text-green-brand hover:text-white transition-all duration-300 text-[60px] opacity-0 group-hover:opacity-100 group-hover:ml-5 ml-0">
                <i class="zmdi zmdi-chevron-left bold-important"></i>
            </div>
            <div class="hero-slider_arrows__nextbtn swipper-arrow text-green-brand hover:text-white transition-all duration-300 text-[60px] opacity-0 group-hover:opacity-100 group-hover:mr-5 mr-0">
